...
{\centering\includegraphics<1|handout:0>[width=\textwidth,height=0.72\textheight,keepaspectratio]{presentation-examplefig}
\includegraphics<2>[width=\textwidth,height=0.72\textheight,keepaspectratio]{presentation-examplefig-magenta}
}
...
{\centering\includegraphics[width=\textwidth]{presentation-examplefig-electrodes}
}
