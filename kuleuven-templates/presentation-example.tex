...
{%
    ...
    \mdseries\insertframenumber~/ \inserttotalframenumber%
    \end{beamercolorbox}%
}
...
{\centering\includegraphics<1|handout:0>[width=\linewidth]{presentation-examplefig}
\includegraphics<2>[width=\linewidth]{presentation-examplefig-magenta}
\par}
...
\item
  Citations \autocites{Macherey2006}{Francart2008} and
  \textcite{Macherey2006}, with clickable link to Pubmed/Amazon
\item
...
\item
  ...
  \end{itemize}
\item
  Item 2\\ Continue without bullet
\item
  Item 3
\end{itemize}
...
\includepdf[pages=-,fitpaper=false,frame=true,pagecommand={},scale=1]{figures/pdfslide.pdf}
...
\begin{figure}
\includegraphics[width=\linewidth]{presentation-examplefig-electrodes}
