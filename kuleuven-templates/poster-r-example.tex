...
\begin{figure}
\includegraphics[width=0.5\linewidth]{presentation-examplefig}
\includegraphics[width=0.5\linewidth]{presentation-examplefig-magenta}
...
\begin{figure}
\includegraphics[]{poster-r-example-figures/iris-1.pdf}
\caption{iris data}
\end{figure}
...
\begin{figure}
\includegraphics[width=.7\linewidth]{presentation-examplefig-electrodes}
\caption{electrodes!}
\end{figure}
