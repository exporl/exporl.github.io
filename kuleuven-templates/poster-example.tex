...
\usepackage[size=custom,width=100,height=100
    ,width=90,height=116.3,scale=1.2
...
\setbeamertemplate{footline}{
  ...
  \begin{beamercolorbox}[ht=4ex,leftskip=1cm,rightskip=1cm]{footline}%
    \url{university.edu} \hfill Institute, Department, University, Country \hfill \texttt{author@university.edu}
    \vskip.8ex
  \end{beamercolorbox}
}
...
\begin{figure}
\includegraphics[width=0.5\linewidth,trim=0 0 0 1cm]{presentation-examplefig}
\includegraphics[width=0.5\linewidth,trim=-1cm 0 0 0]{presentation-examplefig-magenta}
\caption{two figures side-by-side}
\end{figure}

\structure{Default lists}
...
\column{(\linewidth-1cm)*\real{0.670000}}

\structure{Columns within columns within blocks within columns}

\begin{columns}

\column{(\linewidth-1cm)*\real{0.590000}}

\lipsum[3]

\column{(\linewidth-1cm)*\real{0.410000}}

\lipsum[4]

\end{columns}

\column{(\linewidth-1cm)*\real{0.330000}}
...
\begin{figure}
\includegraphics[width=.8\linewidth]{presentation-examplefig-electrodes}
\caption{electrodes!}
\end{figure}
...
\column{(\linewidth-1cm)*\real{0.400000}}
...
\column{(\linewidth-1cm)*\real{0.600000}}
